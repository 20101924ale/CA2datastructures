...
public class Destination {
        ...
        private Map<Destination, Double> neighborStations; // A map of neighboring stations and their distances
        private List<Double> distances; // A list of distances to the neighborStations
        private List<DestinationLine> lines; // A list of lines that the station is on
        private double distanceFromFirstStation = Double.MAX_VALUE; // Distance from the start station for Dijkstra's algorithm
        private Destination previousStation; // Previous station in the shortest path from the start station

        // CONSTRUCTOR
        public Destination(String stationName, double x, double y) {
        ...
        public Map<Destination, Double> getNeighborStations() {
            return neighborStations; // Get the map of neighboring stations and their distances
        }

        public List<DestinationLine> getLines() {
        ...
        public Destination getPreviousStation() {
        ...
        public void setNeighborStations(Map<Destination, Double> neighborStations) {
        ...
        public void setPreviousStation(Destination previousStation) {
        ...
        public String toString() {
            String neighborNames = neighborStations.keySet().stream()
                    .map(Destination::getStationName)
